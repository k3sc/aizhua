	...
	<div class="wrap js-check-wrap">
		...
		<form class="js-ajax-form" method="post">
			<div class="table-actions">
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminPage/listorders');?>"><?php echo L('SORT');?></button>
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
					...
					<td>
						<a href="<?php echo U('AdminPage/edit',array('id'=>$vo['id']));?>">编辑</a>
						<?php if($vo['id'] > '5'): ?><a href="<?php echo U('AdminPage/delete',array('id'=>$vo['id']));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a><?php endif; ?>
					</td>
