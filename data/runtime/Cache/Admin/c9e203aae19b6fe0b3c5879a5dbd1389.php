...
<div class="wrap">
    ...
    <form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Capturewawa/edit_post',array('id'=>$get_id));?>">
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <span id="gift_img" style="position: relative;">
                        <?php if(is_array($wawa["img"])): foreach($wawa["img"] as $k=>$vo): if(!empty($vo)): ?><div style="display: inline;">
                                    <a href="javascript:;" class="del btn btn-danger btn-small" style="position: relative;">X</a>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="chuhuo" value="<?php echo ($wawa['chuhuo']); ?>" readonly>
                    <span class="form-required">*</span>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="count_success" value="<?php echo ($wawa['count_success']); ?>" readonly>
                    <span class="form-required">*</span>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="count" value="<?php echo ($wawa['count']); ?>" readonly>
                    <span class="form-required">*</span>
                </div>
            </div>
