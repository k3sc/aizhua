...
<div class="wrap">
	<ul class="nav nav-tabs">
		<li><a href="<?php echo U('Gift/type_list');?>" >礼品分类列表</a></li>
		<li class="active"><a>礼品分类编辑</a></li>
	</ul>
	<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Gift/type_add');?>">
		<fieldset>
		...
		<div class="form-actions">
			...
			<a class="btn" href="<?php echo U('Gift/type_list');?>"><?php echo L('BACK');?></a>
		</div>
	</form>
</div>
