...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('slide/index');?>">广告管理</a></li>
			<li><a href="<?php echo U('slide/add');?>">添加</a></li>
		</ul>
		...
		<form class="js-ajax-form" method="post">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($slides)): foreach($slides as $key=>$vo): ?><tr>
					...
					<td>
						<a href="<?php echo U('slide/edit',array('id'=>$vo['slide_id']));?>">编辑</a>
						<a href="<?php echo U('slide/delete',array('id'=>$vo['slide_id']));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a>
						<!--<?php if(empty($vo['slide_status']) == 1): ?>-->
							<!--<a href="<?php echo U('slide/cancelban',array('id'=>$vo['slide_id']));?>" class="js-ajax-dialog-btn" data-msg="确定显示此幻灯片吗？"><?php echo L('DISPLAY');?></a>-->
						<!--<?php else: ?> -->
							<!--<a href="<?php echo U('slide/ban',array('id'=>$vo['slide_id']));?>" class="js-ajax-dialog-btn" data-msg="确定隐藏此图片吗？"><?php echo L('HIDE');?></a>-->
						<!--<?php endif; ?>-->
					</td>
