...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Chargerules/index');?>">充值规则列表</a></li>
			<li><a href="<?php echo U('Chargerules/add');?>">充值规则添加</a></li>
		</ul>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td><?php echo ($vo['give_coin']); ?></td>
						<!--<td><?php echo ($vo['firstgive']); ?></td>-->
