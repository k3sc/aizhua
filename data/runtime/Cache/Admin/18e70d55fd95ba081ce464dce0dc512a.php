...
<body>
  <div class="wrap">
    <ul class="nav nav-tabs">
      <li><a href="<?php echo U('Activeconfig/index');?>">上币活动列表</a></li>
      <li class="active"><a href="javascript:;">添加上币活动</a></li>
    </ul>
    <form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Activeconfig/add_act');?>">
      <fieldset>
        ...
        <div class="control-group" id="userMain" style="">
          ...
          <div class="controls">
            <textarea name="users" id="userList" style="width:400px;height:150px;"> <?php echo ($arrAct['users']); ?></textarea>
