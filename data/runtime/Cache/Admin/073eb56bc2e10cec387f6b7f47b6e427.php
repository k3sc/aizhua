...
<div class="wrap">
    ...
    <form method="post" class="well form-search" action="<?php echo U('Probability/sell');?>">
    ...
    <table class="table table-hover table-bordered">
        ...
        <?php if(is_array($row)): foreach($row as $key=>$vo): ?><tr>
                ...
                <td class="isstart">
                    <a href="javascript:;" data="<?php echo ($vo["id"]); ?>" <?php if(($vo["is_sellmodel"]) == "0"): ?>class="btn btn-danger btn-small"<?php else: ?>class="btn btn-success btn-small"<?php endif; ?> ><?php if(($vo["is_sellmodel"]) == "0"): ?>停用<?php else: ?>启用<?php endif; ?></a>
                </td>
                <!--<td align="center">-->
    ...
    <a href="<?php echo U('Probability/sellmodel_list');?>" class="btn btn-danger">设置用户贩卖模式规则</a>
...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo U('Probability/batch_action');?>" method="post">
...
<script>
    $(document).ready(function () {
        ...
        $(".isstart a").click(function () {
            ...
            $.ajax({
                url : "<?php echo U('Probability/isstart');?>",
                type : 'post',
                dataType : 'json',
                data : 'id='+id,
                success : function (res) {
