		...
		<form  method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data" action="">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" value="<?php echo ($data["type_id"]); ?>">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="introduce" value="<?php echo ($data["shipment_num"]); ?>">
						<span class="form-required">*</span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="introduce" value="<?php echo (date('Y-m-d H:i:s',$data["ctime"])); ?>">
						<span class="form-required">*</span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<div >
							<img src="<?php echo ($data["img"]); ?>" style="width: 135px;height: 106px;"/>
						</div>
						<span class="form-required"></span>
					</div>
				</div>
