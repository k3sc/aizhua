...
<meta charset="utf-8">
<title>房一起自助娃娃机 <?php echo L('ADMIN_CENTER');?></title>
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<img src="/admin/themes/simplebootx/Public/assets/images/logo-18.png">
					房一起自助娃娃机 <?php echo L('ADMIN_CENTER');?>
				</small>
				</a>
				...
				<ul class="nav simplewind-nav pull-right">
					...
					<li class="purple dropdown-modal">
						<a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false">
							...
							<span class="badge badge-important" id="notice_count">0</span>
						</a>
						...
						<ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close" style="width:300px;">
							<li class="dropdown-header">
								...
								<span style="color:white;"><b>最新通知</b></span>
							</li>
							...
							<li class="dropdown-content ace-scroll">
								...
								<div class="scroll-content" style="">
									<ul class="dropdown-menu dropdown-navbar navbar-pink timer_notice_list" style="right: 0px;height: 70vh; overflow:scroll;"></ul>
								</div>
							</li>
						</ul>
					</li>
...
<script>
	$(function () {
        var timer_notice_list = $('.timer_notice_list');

        $.post("<?php echo U('Service/bill');?>", {}, function(res){
            if(res.status == 1){
                $("#notice_count").text(res.count);
                var html = '';
                $.each(res.list, function(i, v){
                    html += '<li> <a href="javascript:;"> <div class="clearfix"> <span class="pull-left"> <i class="btn btn-xs no-hover btn-pink fa fa-comment"></i>' +  v['room_name'] + '(' + v['room_no'] + ')'  + ', 需要人工服务:' + v['content'] + '</span> <span class="pull-right badge badge-info"></span> </div> </a> </li>';
                });
                timer_notice_list.css('display','block').html(html);
            }else{
                $("#notice_count").text(0);
            }
        }, 'json');
