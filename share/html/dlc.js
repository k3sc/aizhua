...
//$('#scroll_show').on('click',function(){
//  showMask();
//  $('.sel_scroll').show();
//});
//$('.sel_scroll').on('click','#cancel',function(){
//  hideMask();
//  $('.sel_scroll').hide();
//});
//$('.sel_scroll').on('click','#sure',function(){
//  hideMask();
//  $('.sel_scroll').hide();
//  if($('.sel_scroll li').hasClass('active')){
//      var selectLi = $('.sel_scroll li').html();
//      $('input[name="age"]').val(selectLi);
//  }
//});
var dlctipbox = {
